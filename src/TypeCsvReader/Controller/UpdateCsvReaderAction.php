...
final class UpdateCsvReaderAction implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        try {
            ...
            $em->persist($entity);
            $em->flush();
            $msg = 'CsvReader has been updated!';
            ...
            return (new ResponseFactory())('Error while updating csv_reader.', 400, 'csv_reader');
        }
    }
}

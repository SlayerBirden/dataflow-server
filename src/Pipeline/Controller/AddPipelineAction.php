...
final class AddPipelineAction implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        try {
            ...
            $em = $this->managerRegistry->getManagerForClass(Pipeline::class);
            $em->persist($entity);
            $em->flush();
            $msg = 'Pipeline has been successfully created!';
            return (new ResponseFactory())($msg, 200, 'pipeline', $this->hydrator->extract($entity));
        } catch (ORMInvalidArgumentException | ValidationException $exception) {
            return (new ResponseFactory())($exception->getMessage(), 400, 'pipeline');
        } catch (ORMException $exception) {
            $this->logger->error((string)$exception);
            return (new ResponseFactory())('Error during creation operation.', 400, 'pipeline');
        }
    }
}

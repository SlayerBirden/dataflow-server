...
final class AddPipeAction implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        try {
            ...
            $em->persist($entity);
            $em->flush();
            $msg = 'Pipe has been successfully created!';
            ...
            return (new ResponseFactory())('Error during creation operation.', 400, 'pipe');
        }
    }
}

...
final class UpdatePipelineAction implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        try {
            ...
            return (new ResponseFactory())('Error while updating pipeline.', 400, 'pipeline');
        }
    }
}

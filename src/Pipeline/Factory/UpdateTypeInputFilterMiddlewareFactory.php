...
final class UpdateTypeInputFilterMiddlewareFactory implements FactoryInterface
{
    public function __invoke(
        ...
        return new InputFilterMiddleware($container->get('UpdateTypeInputFilter'), 'type');
    }
}

...
final class PipelineInputFilterMiddlewareFactory implements FactoryInterface
{
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null): InputFilterMiddleware
    {
        return new InputFilterMiddleware($container->get('PipelineInputFilter'), 'pipeline');
    }
}
